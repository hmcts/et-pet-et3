...
RSpec.feature "Fill in Earnings and Benefits Page", js: true do
  ...
  scenario "correctly will enable user to check answers and return to edit them" do
    ...
    expect(earnings_and_benefits_page.agree_with_claimants_hours_question.yes.has_checked_field?).to be true if user.agree_with_claimants_hours == "Yes"
    expect(earnings_and_benefits_page.agree_with_claimants_hours_question.no.has_checked_field?).to be true if user.agree_with_claimants_hours == "No"
    ...
    expect(earnings_and_benefits_page.agree_with_earnings_details_question.yes.has_checked_field?).to be true if user.agree_with_earnings_details == "Yes"
    expect(earnings_and_benefits_page.agree_with_earnings_details_question.no.has_checked_field?).to be true if user.agree_with_earnings_details == "No"
    ...
    expect(earnings_and_benefits_page.agree_with_claimant_notice_question.yes.has_checked_field?).to be true if user.agree_with_claimant_notice == "Yes"
    expect(earnings_and_benefits_page.agree_with_claimant_notice_question.no.has_checked_field?).to be true if user.agree_with_claimant_notice == "No"
    ...
    expect(earnings_and_benefits_page.agree_with_claimant_pension_benefits_question.yes.has_checked_field?).to be true if user.agree_with_claimant_pension_benefits == "Yes"
    expect(earnings_and_benefits_page.agree_with_claimant_pension_benefits_question.no.has_checked_field?).to be true if user.agree_with_claimant_pension_benefits == "No"
