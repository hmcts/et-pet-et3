...
RSpec.configure do |c|
  c.before(:suite) do
    ...
    minio_s3_client = Aws::S3::Client.new(minio_config)
    Aws::S3::Bucket.new(client: minio_s3_client, name: ENV.fetch('S3_DIRECT_UPLOAD_BUCKET', 'et3directbuckettest')).tap do |bucket|
