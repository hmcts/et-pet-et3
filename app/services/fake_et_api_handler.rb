...
class FakeEtApiHandler
  ...
  def self.validate_response(_attribute, value)
    offices = [13, 14, 15, 16, 17, 18, 19, 22, 23, 24, 25, 26, 27, 31, 32, 33, 34, 41, 50, 51, 99]
    if offices.include?(value.first(2).to_i)
