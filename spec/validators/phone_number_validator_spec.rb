...
RSpec.describe PhoneNumberValidator do
  ...
  it 'does not validate a string with less than 7 integers' do
  ...
  it 'validates a string that starts with an international call code' do
  ...
  it 'validates a string with 7 integers and dashes' do
    model = model_class.new(number: "0203-123-4567")
