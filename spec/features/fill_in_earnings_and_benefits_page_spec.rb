...
RSpec.feature "Fill in Earnings and Benefits Page", js: true do
  ...
  scenario "correctly will enable user to check answers and return to edit them" do
    ...
    expect(earnings_and_benefits_page.agree_with_claimants_hours_question.queried_hours.field.value.to_f).to eql user.queried_hours.to_f
    # expect(earnings_and_benefits_page.agree_with_earnings_details_question.get).to eql user.agree_with_earnings_details
    # expect(earnings_and_benefits_page.agree_with_earnings_details_question.queried_pay_before_tax.field.value).to eql user.queried_pay_before_tax.to_f
