module ET3
  module Test
    class EarningsAndBenefitsPage < BasePage
      ...
      gds_text_area :disagree_claimant_notice_reason, :'questions.earnings_and_benefits.disagree_claimant_notice_reason', exact: false, visible: true
      ...
      gds_text_area :disagree_claimant_pension_benefits_reason, :'questions.earnings_and_benefits.disagree_claimant_pension_benefits_reason', exact: false, visible: true
